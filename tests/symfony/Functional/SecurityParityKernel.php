...
class SecurityParityKernel extends Kernel
{
    ...
    public function __construct(private readonly bool $switched)
    {
    ...
    protected function configureContainer(ContainerBuilder $container, LoaderInterface $loader): void
    {
        ...
        $container->loadFromExtension('security', [
                ...
                'main' => [
                    'memory' => [
                        'users' => [
                            ...
                            'carol' => ['password' => 'pa$$word', 'roles' => ['ROLE_MANAGER']],
                        ],
                    ],
                ],
            ],
            ...
            'firewalls' => [
                'main' => ['pattern' => '^/', 'http_basic' => null, 'provider' => 'main'],
            ],
            'access_control' => [
                ['path' => '^/dashboard/admin', 'roles' => 'ROLE_ADMIN'],
                ['path' => '^/dashboard', 'roles' => 'ROLE_USER'],
                ['path' => '^/either', 'roles' => ['ROLE_ADMIN', 'ROLE_MANAGER']],
                ['path' => '^/allow-if', 'allow_if' => "is_granted('ROLE_ADMIN') and request.getMethod() == 'GET'"],
                ['path' => '^/by-ip', 'ips' => ['10.0.0.1'], 'roles' => 'ROLE_SUPER_ADMIN'],
                ['path' => '^/by-ip', 'roles' => 'PUBLIC_ACCESS'],
                ['path' => '^/by-method', 'methods' => ['POST'], 'roles' => 'ROLE_SUPER_ADMIN'],
                ['path' => '^/by-method', 'roles' => 'PUBLIC_ACCESS'],
                ['path' => '^/by-host', 'host' => 'forbidden\.example\.com', 'roles' => 'ROLE_SUPER_ADMIN'],
                ['path' => '^/by-host', 'roles' => 'PUBLIC_ACCESS'],
                ['path' => '^/secure-channel', 'roles' => 'PUBLIC_ACCESS', 'requires_channel' => 'https'],
